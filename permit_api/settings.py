"""
Django settings for permit_api project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-^!^e-#zw7aiwve$d2phfvx0rn*2d1mio1z0jnjtx9z94@-!v_&')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DEBUG', 'True') == 'True'

# Allow hosts from environment variable or default for development
...
WSGI_APPLICATION = 'permit_api.wsgi.application'
